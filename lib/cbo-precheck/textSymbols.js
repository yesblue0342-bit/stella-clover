...
export function parseTextsDoc(content) {
  ...
  for (const rawLine of String(content || "").split("\n")) {
    ...
    else if (section === "title" && !title) title = value;
  }

  return { textSymbols, selectionTexts, title };
}

export const EMPTY_TEXTS_MAP = Object.freeze({ textSymbols: Object.freeze({}), selectionTexts: Object.freeze({}), title: null });
